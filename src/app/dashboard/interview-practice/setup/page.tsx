...
import { FileUp, Loader2, Sparkles, Clock, ArrowLeft } from 'lucide-react';
    ...
    >
      ...
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold tracking-tight">Mock Interview Setup</CardTitle>
          <CardDescription>Configure your practice session for a tailored experience.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex justify-end gap-4">
                 <Button type="button" variant="outline" onClick={() => router.push('/dashboard/interview-practice')}>Cancel</Button>
