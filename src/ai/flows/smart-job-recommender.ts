...
const prompt = ai.definePrompt({
  ...
  **User Preferences:**
  ...
  - **Preferred Locations:** {{#each jobPreferences.locations}}{{{this}}}{{#unless @last}}, {{/unless}}{{/each}}
  ...
  **Instructions:**
  1.  Find **10-15 currently open job roles** that are an excellent match for the user's selected roles/skills and preferences.
